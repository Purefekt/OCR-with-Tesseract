...
scanned_page_images_with_ground_truth_bbox_dir = '/Users/veersingh/Desktop/docs_with_signs_dataset(' \
                                                 'tobacco800)/scanned_page_images_with_ground_truth_bbox/'
...
for filename in ground_truth_bbox.keys():
    ...
    cv2.imwrite(scanned_page_images_with_ground_truth_bbox_dir + current_image_name, image)
