...
images_dir = '/Users/veersingh/Desktop/docs_with_signs_dataset(tobacco800)/scanned_page_images'
...
for filename in os.listdir(ground_truth_dir):
    ...
    corresponding_image_file_path = images_dir + '/' + corresponding_image_file_name
