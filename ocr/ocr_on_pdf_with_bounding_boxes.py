...
class ocr_on_pdf:
    ...
    def __init__(self, pdf_path, language='eng', oem=3, psm=3):
    ...
    def ocr_on_pdf(self):
        ...
        pdf_page_images = convert_from_path(self.pdf_path)

        """converts the current page into an image, saves it and then runs ocr on that page. Once completed moves on
        to the next image and overwrites the previous image"""
